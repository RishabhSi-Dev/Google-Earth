...
(Since the Imports panel cannot be pasted directly, a screenshot is provided instead.)

They include:
- AOI (polygon)
- Image collection reference (e.g., Sentinel-2)
...
The Area of Interest (AOI) is Wular Lake, selected for the Surface Water Extraction
...
Binary Image of NDWI Map. Black regions represent non-water bodies (NDWI <= 0), while blue regions represent water bodies (NDWI > 0)
...
This is the RGB image of Area of Interest as observed by the satellite.
...
Above is the NDWI map layer, where non-water bodies appear white.

The next update includes the sampled map layer generated using the Random Forest algorithm.
...
Random Forest–classified map layer: brown indicates non-water bodies, and blue indicates water bodies.
...
Approximate surface water area calculated from the NDWI map and printed in the Google Earth Engine console.

<img width="748" height="576" alt="NON-WATER" src="https://github.com/user-attachments/assets/85c28664-0e05-47e9-8c77-8496678a6cd0" />
Non-water body graph shown in the Inspector tab after clicking on a non-water pixel.

<img width="736" height="576" alt="WATER" src="https://github.com/user-attachments/assets/2d2af021-622c-409e-bfd9-575ccbc8d5cd" />
Water body graph shown in the Inspector tab after clicking on a water pixel.

<img width="3507" height="2480" alt="Wular_Lake_Semi_QGS" src="https://github.com/user-attachments/assets/fe6e3550-f3db-4a55-8581-82cb75e762d6" />
Wular Lake QGIS Map

(In next update, i will update the code and also commit changes)
